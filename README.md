...
During the initial development and **Proof Of Concept (PoC)**/Phase 0 of the solution, the team selected **Decision Trees and Logistic Regression** as the primary AI models. This choice was driven by the need to balance performance with transparency and practical usability in a clinical setting. **Example:** Patient flagged due to missed prescription refills and recent appointment cancellations.
...
2. **Lower Data Requirements:** Decision Trees and Logistic Regression perform effectively even with limited datasets, making them suitable for early stage development when data availability is usually limited.
3. **Ease of Validation:** Their strightforward logic allows both clinical and technical stakeholders to validate model outputs against real-world care workflows enabling accelerating adoption and reducing implementation risk.
